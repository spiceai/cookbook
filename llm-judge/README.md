...
Spice can be used to run language models (LLM) but also to evaluate their performance on specific tasks. Sometimes it's useful to use another language model to judge the performance of another LLM. This is often called an [LLM judge](https://spiceai.org/docs/v1.11/features/large-language-models/evals#llm-judge).
