...
|               |       BytesProcessedExec                                                                                                                                                                                                                                                                                                                                                                                                              |
|               |         DataSourceExec: file_groups={1 group: [[.spice/data/taxi_trips/expr0=3/.../..._00000.vortex]]}, projection=[VendorID, tpep_pickup_datetime, tpep_dropoff_datetime, passenger_count, trip_distance, RatecodeID, store_and_fwd_flag, PULocationID, DOLocationID, payment_type, fare_amount, extra, mta_tax, tip_amount, tolls_amount, improvement_surcharge, total_amount, congestion_surcharge, Airport_fee], file_type=vortex |
|               |     CayenneAccelerationExec: snapshots_scanned=1, files_scanned=1                                                                                                                                                                                                                                                                                                                                                                     |
|               |       BytesProcessedExec                                                                                                                                                                                                                                                                                                                                                                                                              |
|               |         DataSourceExec: file_groups={1 group: [[.spice/data/taxi_trips/expr0=8/.../..._00000.vortex]]}, projection=[VendorID, tpep_pickup_datetime, tpep_dropoff_datetime, passenger_count, trip_distance, RatecodeID, store_and_fwd_flag, PULocationID, DOLocationID, payment_type, fare_amount, extra, mta_tax, tip_amount, tolls_amount, improvement_surcharge, total_amount, congestion_surcharge, Airport_fee], file_type=vortex |
|               |     CayenneAccelerationExec: snapshots_scanned=1, files_scanned=1                                                                                                                                                                                                                                                                                                                                                                     |
|               |       BytesProcessedExec                                                                                                                                                                                                                                                                                                                                                                                                              |
|               |         DataSourceExec: file_groups={1 group: [[.spice/data/taxi_trips/expr0=0/.../..._00000.vortex]]}, projection=[VendorID, tpep_pickup_datetime, tpep_dropoff_datetime, passenger_count, trip_distance, RatecodeID, store_and_fwd_flag, PULocationID, DOLocationID, payment_type, fare_amount, extra, mta_tax, tip_amount, tolls_amount, improvement_surcharge, total_amount, congestion_surcharge, Airport_fee], file_type=vortex |
|               |     CayenneAccelerationExec: snapshots_scanned=1, files_scanned=1                                                                                                                                                                                                                                                                                                                                                                     |
|               |       BytesProcessedExec                                                                                                                                                                                                                                                                                                                                                                                                              |
|               |         DataSourceExec: file_groups={1 group: [[.spice/data/taxi_trips/expr0=7/.../..._00000.vortex]]}, projection=[VendorID, tpep_pickup_datetime, tpep_dropoff_datetime, passenger_count, trip_distance, RatecodeID, store_and_fwd_flag, PULocationID, DOLocationID, payment_type, fare_amount, extra, mta_tax, tip_amount, tolls_amount, improvement_surcharge, total_amount, congestion_surcharge, Airport_fee], file_type=vortex |
|               |     CayenneAccelerationExec: snapshots_scanned=1, files_scanned=1                                                                                                                                                                                                                                                                                                                                                                     |
|               |       BytesProcessedExec                                                                                                                                                                                                                                                                                                                                                                                                              |
|               |         DataSourceExec: file_groups={1 group: [[.spice/data/taxi_trips/expr0=1/.../..._00000.vortex]]}, projection=[VendorID, tpep_pickup_datetime, tpep_dropoff_datetime, passenger_count, trip_distance, RatecodeID, store_and_fwd_flag, PULocationID, DOLocationID, payment_type, fare_amount, extra, mta_tax, tip_amount, tolls_amount, improvement_surcharge, total_amount, congestion_surcharge, Airport_fee], file_type=vortex |
|               |     CayenneAccelerationExec: snapshots_scanned=1, files_scanned=1                                                                                                                                                                                                                                                                                                                                                                     |
|               |       BytesProcessedExec                                                                                                                                                                                                                                                                                                                                                                                                              |
|               |         DataSourceExec: file_groups={1 group: [[.spice/data/taxi_trips/expr0=9/.../..._00000.vortex]]}, projection=[VendorID, tpep_pickup_datetime, tpep_dropoff_datetime, passenger_count, trip_distance, RatecodeID, store_and_fwd_flag, PULocationID, DOLocationID, payment_type, fare_amount, extra, mta_tax, tip_amount, tolls_amount, improvement_surcharge, total_amount, congestion_surcharge, Airport_fee], file_type=vortex |
|               |     CayenneAccelerationExec: snapshots_scanned=1, files_scanned=1                                                                                                                                                                                                                                                                                                                                                                     |
|               |       BytesProcessedExec                                                                                                                                                                                                                                                                                                                                                                                                              |
|               |         DataSourceExec: file_groups={1 group: [[.spice/data/taxi_trips/expr0=4/.../..._00000.vortex]]}, projection=[VendorID, tpep_pickup_datetime, tpep_dropoff_datetime, passenger_count, trip_distance, RatecodeID, store_and_fwd_flag, PULocationID, DOLocationID, payment_type, fare_amount, extra, mta_tax, tip_amount, tolls_amount, improvement_surcharge, total_amount, congestion_surcharge, Airport_fee], file_type=vortex |
|               |     CayenneAccelerationExec: snapshots_scanned=1, files_scanned=1                                                                                                                                                                                                                                                                                                                                                                     |
|               |       BytesProcessedExec                                                                                                                                                                                                                                                                                                                                                                                                              |
|               |         DataSourceExec: file_groups={1 group: [[.spice/data/taxi_trips/expr0=2/.../..._00000.vortex]]}, projection=[VendorID, tpep_pickup_datetime, tpep_dropoff_datetime, passenger_count, trip_distance, RatecodeID, store_and_fwd_flag, PULocationID, DOLocationID, payment_type, fare_amount, extra, mta_tax, tip_amount, tolls_amount, improvement_surcharge, total_amount, congestion_surcharge, Airport_fee], file_type=vortex |
|               |     CayenneAccelerationExec: snapshots_scanned=1, files_scanned=1                                                                                                                                                                                                                                                                                                                                                                     |
|               |       BytesProcessedExec                                                                                                                                                                                                                                                                                                                                                                                                              |
|               |         DataSourceExec: file_groups={1 group: [[.spice/data/taxi_trips/expr0=5/.../..._00000.vortex]]}, projection=[VendorID, tpep_pickup_datetime, tpep_dropoff_datetime, passenger_count, trip_distance, RatecodeID, store_and_fwd_flag, PULocationID, DOLocationID, payment_type, fare_amount, extra, mta_tax, tip_amount, tolls_amount, improvement_surcharge, total_amount, congestion_surcharge, Airport_fee], file_type=vortex |
|               |     CayenneAccelerationExec: snapshots_scanned=1, files_scanned=1                                                                                                                                                                                                                                                                                                                                                                     |
|               |       BytesProcessedExec                                                                                                                                                                                                                                                                                                                                                                                                              |
|               |         DataSourceExec: file_groups={1 group: [[.spice/data/taxi_trips/expr0=6/.../..._00000.vortex]]}, projection=[VendorID, tpep_pickup_datetime, tpep_dropoff_datetime, passenger_count, trip_distance, RatecodeID, store_and_fwd_flag, PULocationID, DOLocationID, payment_type, fare_amount, extra, mta_tax, tip_amount, tolls_amount, improvement_surcharge, total_amount, congestion_surcharge, Airport_fee], file_type=vortex |
|               |                                                                                                                                                                                                                                                                                                                                                                                                                                       |
+---------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
In this case, only one partitioned file is relevant for scanning and remains in the scan plan while all other partitions are pruned from the plan — a single `CayenneAccelerationExec` reading the `expr0=7` partition.
...
|               |               CayenneAccelerationExec: snapshots_scanned=1, files_scanned=1                                                                                                                                                       |
|               |                 BytesProcessedExec                                                                                                                                                                                                |
|               |                   DataSourceExec: file_groups={1 group: [[.spice/data/taxi_trips/expr0=7/.../..._00000.vortex]]}, projection=[PULocationID], file_type=vortex, predicate: PULocationID@7 = 221                                    |
|               |                                                                                                                                                                                                                                   |
+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
